        ...
        const Input = class {
          ...
          render() {
            ...
            return (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(
              ...
              this.clearInput && !this.readonly && !this.disabled && (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)('button', { 'aria-label': 'reset', type: 'button', class: 'input-clear-icon', onTouchStart: this.clearTextInput, onMouseDown: this.clearTextInput, onKeyDown: this.clearTextOnEnter })
            );
          }
          get el() {
