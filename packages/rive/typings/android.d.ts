      ...
      export module kotlin {
        ...
        export module RiveArtboardRenderer {
          export class Listener {
             ...
             */
            public constructor(implementation: { notifyPlay(param0: app.rive.runtime.kotlin): void; notifyPause(param0: app.rive.runtime.kotlin): void; notifyStop(param0: app.rive.runtime.kotlin): void; notifyLoop(param0: app.rive.runtime.kotlin): void; notifyStateChanged(param0: string, param1: string): void });
            public constructor();
