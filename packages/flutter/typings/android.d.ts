        ...
        export module plugins {
          export module activity {
            export class ActivityControlSurface {
               ...
               */
              public constructor(implementation: { attachToActivity(param0: io.flutter.embedding.android.ExclusiveAppComponent<globalAndroid.app.Activity>, param1: androidx.lifecycle.Lifecycle): void; detachFromActivityForConfigChanges(): void; detachFromActivity(): void; onRequestPermissionsResult(param0: number, param1: androidNative.Array<string>, param2: androidNative.Array<number>): boolean; onActivityResult(param0: number, param1: number, param2: globalAndroid.content.Intent): boolean; onNewIntent(param0: globalAndroid.content.Intent): void; onUserLeaveHint(): void; onSaveInstanceState(param0: globalAndroid.os.Bundle): void; onRestoreInstanceState(param0: globalAndroid.os.Bundle): void });
              public constructor();
              public onRequestPermissionsResult(param0: number, param1: androidNative.Array<string>, param2: androidNative.Array<number>): boolean;
              public onRestoreInstanceState(param0: globalAndroid.os.Bundle): void;
              public onUserLeaveHint(): void;
        ...
        export module systemchannels {
          ...
          export module TextInputChannel {
            ...
            export class TextInputMethodHandler {
               ...
               */
              public constructor(implementation: { show(): void; hide(): void; requestAutofill(): void; finishAutofillContext(param0: boolean): void; setClient(param0: number, param1: io.flutter.embedding.engine.systemchannels.TextInputChannel.Configuration): void; setPlatformViewClient(param0: number, param1: boolean): void; setEditableSizeAndTransform(param0: number, param1: number, param2: androidNative.Array<number>): void; setEditingState(param0: io.flutter.embedding.engine.systemchannels.TextInputChannel.TextEditState): void; clearClient(): void; sendAppPrivateCommand(param0: string, param1: globalAndroid.os.Bundle): void });
              public constructor();
